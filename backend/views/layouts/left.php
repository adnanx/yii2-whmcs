...
<aside class="left-side sidebar-offcanvas">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
			...
			<li<?php //if (Yii::getController()->getId() == 'languages') echo ' class="active"'; ?>>
				<a href="<?php echo Url::to(['languages/index']); ?>">
					<i class="fa fa-language fa-fw fa-lg"></i> <span class="menu-text"><?php echo \Yii::t('languages', 'Languages'); ?> <span class="badge pull-right"><?php echo Languages::find()->count(); ?></span></span>
				</a>
			</li>
        </ul>
